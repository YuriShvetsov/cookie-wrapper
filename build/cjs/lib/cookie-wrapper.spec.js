...
var cookie_wrapper_1 = require("./cookie-wrapper");
...
describe('Cookie handling', function () {
    ...
    it('returns the correct value of the cookies item', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            document.cookie = "".concat(cookieName, "=").concat(cookieValue, "; domain=site.com");
            foundCookieValue = cookie_wrapper_1.cookieWrapper.get('test_cookie_1');
    ...
    it('adds a new cookie', function () {
        ...
        cookie_wrapper_1.cookieWrapper.set(cookieName, cookieValue);
    ...
    it('adds a new cookie with expires option', function () { return __awaiter(void 0, void 0, void 0, function () {
        var cookieName, cookieValue, dateAfterOneSecond, foundCookie;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cookieName = 'test_cookie_4';
                    cookieValue = 'test_value_4';
                    dateAfterOneSecond = new Date(Date.now() + 2000);
                    cookie_wrapper_1.cookieWrapper.set(cookieName, cookieValue, {
                        expires: dateAfterOneSecond
                    });
                    foundCookie = cookie_wrapper_1.cookieWrapper.get(cookieName);
                    return [4 /*yield*/, (0, delay_1.delay)(1000)];
                case 1:
                    _a.sent();
